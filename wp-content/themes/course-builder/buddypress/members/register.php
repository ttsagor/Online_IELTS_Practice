							...
							<?php while ( bp_profile_fields() ) : bp_the_profile_field(); ?>
								...
								<div<?php bp_field_css_class( 'editfield' ); ?>>
									...
									?>
												...
												<button type="button" class="visibility-toggle-link" aria-describedby="<?php bp_the_profile_field_input_name(); ?>-2" aria-expanded="false"><?php echo esc_html_x( 'Change', 'Change profile field visibility level', 'course-builder' ); ?></button>
											</p>
