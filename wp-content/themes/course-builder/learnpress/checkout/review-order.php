...
<h3 class="title"><?php esc_html_e( 'Your order', 'course-builder' ); ?></h3>

<table class="learn-press-checkout-review-order-table">
	<thead>
	<tr>
		<th class="course-name"><?php esc_html_e( 'Course', 'course-builder' ); ?></th>
		<th class="course-total"><?php esc_html_e( 'Total', 'course-builder' ); ?></th>
	</tr>
	</thead>
	<tbody>
	...
	<tr class="cart-subtotal">
		<th><?php esc_html_e( 'Subtotal', 'course-builder' ); ?></th>
		<td><?php echo esc_attr( $cart->get_subtotal() ); ?></td>
	</tr>

	<?php do_action( 'learn_press_review_order_before_order_total' ); ?>

	<tr class="order-total">
		<th><?php esc_html_e( 'Total', 'course-builder' ); ?></th>
		<td><?php echo esc_attr( $cart->get_total() ); ?></td>
	</tr>
