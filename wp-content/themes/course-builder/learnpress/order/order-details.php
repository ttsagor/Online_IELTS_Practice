...
?>
<div class="lp_order_details">
	<h2><?php esc_html_e( 'Order Details', 'course-builder' ); ?></h2>
	<table class="order_table order_details">
		...
		<tr>
			<th scope="row"><?php esc_html_e( 'Subtotal', 'course-builder' ); ?></th>
			<td><?php echo( $order->get_formatted_order_subtotal() ); ?></td>
		</tr>
		<tr>
			<th scope="row"><?php esc_html_e( 'Total', 'course-builder' ); ?></th>
