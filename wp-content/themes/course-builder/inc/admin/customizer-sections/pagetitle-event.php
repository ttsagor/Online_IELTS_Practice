...
thim_customizer()->add_field(
	array(
		...
		'js_vars'   => array(
			array(
				'element'  => 'body.post-type-archive-tp_event .page-title .main-top .content .text-title h1, body.post-type-archive-tp_event .page-title .main-top .content .text-title h2',
				'function' => 'html',
			),
		)
	)
...
thim_customizer()->add_field(
	array(
		...
		'js_vars'   => array(
			array(
				'element'  => 'body.post-type-archive-tp_event .page-title .banner-description',
				'function' => 'html',
			),
		)
	)
