...
<div class="section-wrap">
	...
	<div class="lp-form-field-wrap">
		...
		<div class="promoted-checkbox">
			<input id="my-dashboard" type="checkbox" class="svg-input-checkbox" name="publicity[my-dashboard]"
			       value="yes" <?php checked( $profile->get_publicity( 'my-dashboard' ), 'yes' ); ?>/>
			<label for="my-dashboard">
				<svg>
					<use xlink:href="#checkmark" />
				</svg>
				<?php esc_html_e( 'Public your profile dashboard', 'course-builder' ); ?>
			</label>
		</div>

		<?php if ( LP()->settings()->get( 'profile_publicity.courses' ) === 'yes' ) { ?>
			<div class="promoted-checkbox">
				<input type="checkbox" class="svg-input-checkbox" name="publicity[courses]" value="yes"
				       id="my-courses" <?php checked( $profile->get_publicity( 'courses' ), 'yes' ); ?>/>
				<label for="my-courses">
					<svg>
						<use xlink:href="#checkmark" />
					</svg>
					<?php esc_html_e( 'Public your profile courses', 'course-builder' ); ?>
				</label>
			</div>
		<?php } ?>
		...
		<?php if ( LP()->settings()->get( 'profile_publicity.quizzes' ) === 'yes' ) { ?>
			<div class="promoted-checkbox">
				<input name="publicity[quizzes]" class="svg-input-checkbox" value="yes" type="checkbox"
				       id="my-quizzes" <?php checked( $profile->get_publicity( 'quizzes' ), 'yes' ); ?>/>
				<label for="my-quizzes">
					<svg>
						<use xlink:href="#checkmark" />
					</svg>
					<?php esc_html_e( 'Public your profile quizzes', 'course-builder' ); ?>
				</label>
			</div>
		<?php } ?>
