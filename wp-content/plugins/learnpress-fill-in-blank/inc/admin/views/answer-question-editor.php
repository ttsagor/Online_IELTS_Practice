    ...
    <div id="lp-admin-question-editor" class="admin-fib-question-editor">
        <div class="lp-box-data-content">
            <div class="learn-press-question">
                <textarea id="<?php echo $content_id; ?>" @blur="updateAnswer" v-model="answers[0].text"
                ...
                <p>
                    ...
                    <button class="button" type="button"
                            @click="clearBlanks"
                            v-bind:disabled="blanks.length == 0"><?php _e( 'Clear all blanks', 'learnpress-fill-in-blanl' ); ?></button>
                </p>
                <div class="description">
                    <p><?php _e( 'Select a word and click button above to set a blank for filling.', 'learnpress-fill-in-blank' ); ?></p>
                    <p v-if="!valid" class="invalid">
						<?php esc_html_e( 'Wrong format', 'learnpress-fill-in-blank' ); ?>
                    </p>
                </div>
    ...
    (function (Vue, $store, $) {
        ...
        Vue.component('lp-fib-question-answer', {
            ...
            computed: {
                ...
                pattern: function () {
                    return $store.getters['state'].shortcode_pattern;
                }
            },
            methods: {
