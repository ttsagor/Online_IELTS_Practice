...
if ( ! class_exists( 'Thim_SC_Gallery_Carousel' ) ) {
	...
	class Thim_SC_Gallery_Carousel {
		...
		public function assets() {
			wp_register_script( 'thim-gallery-carousel', THIM_CB_URL . $this->base . '/assets/js/gallery-carousel-custom.js', array(
				'jquery',
				'owlcarousel'
			), '', true );
		...
		public function map() {
			vc_map( array(
				...
				'icon'        => THIM_CB_URL . $this->base . '/assets/images/icon/sc-gallery-carousel.png',
				'params'      => array(
