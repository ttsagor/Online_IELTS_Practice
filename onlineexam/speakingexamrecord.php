...
<body>
    <article>
        <header style="text-align: center;">
            <h1>
               IELTS practice zone Speaking test
            </h1>
			<p>
			1. Please 'Allow' Mircophone in your browser<br />
			2. Get your Mics and headphones ready<br />
			3. Press 'Start Recording' to Record your Speech<br />
			4. Press 'Stop Recording' to End Recording your Speech<br />
			5. Press 'Upload To Server' to Save your Specch<br />
			6. Press 'Submit' to Save your Specch</p>
        </header>
        ...
        <section class="experiment recordrtc">
            ...
            <br>
            <video controls muted playsinline style='display:none;'></video>
			<form action='<?php echo "http://" . $_SERVER['SERVER_NAME'] .'/onlineexam/index.php/Exampanel/submitrecordedaudio'; ?>' method='post'>
                ...
                recordingDIV.querySelector('#upload-to-server').onclick = function() {
                    ...
                    uploadToServer(recordRTC, function(progress, fileURL) {
                        if(progress === 'ended') {
							...
							document.getElementById('file_name').value=fileURL;
