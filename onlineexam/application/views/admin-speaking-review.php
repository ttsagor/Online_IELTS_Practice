...
<body style='margin:20px;'>
    <form method='post' action='<?php echo base_url().'index.php/AdminPanel/reviewspeakinganswerpreviewsubmit' ?>'>    
	<div>
		<div>
	...
	<div>
		...
		<div style='border:1px solid #4d94ff;margin:10px;padding:10px;color:#4d94ff'>
			...
			<h3>Your Comment</h3>
    		<textarea name='com2' id='com2' rows='8' cols='50' required></textarea>
		</div>
	</div>
	<div>
		<div>
		...
		<div style='border:1px solid #4d94ff;margin:10px;padding:10px;color:#4d94ff'>
			...
			<h3>Your Comment</h3>
    		<textarea name='com3' id='com3' rows='8' cols='50' required></textarea>
    ...
    <a class="btn btn-info" href="<?php echo base_url(); ?>index.php/AdminPanel/pendingspeakingexamreview">Go Back</a>
</form>
