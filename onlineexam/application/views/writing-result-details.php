...
<div class="container" style='margin:auto;width:100%'> 
  ...
  <p><b>Section one:</b> 
		<?php 
			if($log->writing_answer_1_com=='')
			{
				echo "<i>(Not Reviewed Yet)</i>";
			}
			else{
				echo "$log->writing_answer_1_com";
			}
		?>
  </p>
  ...
  <p><b>Section two:</b>
		<?php 
			if($log->writing_answer_2_com=='')
			{
				echo "<i>(Not Reviewed Yet)</i>";
			}
			else{
				echo "$log->writing_answer_2_com";
			}
		?>
  </p>
  ...
  <a class="btn btn-info" href="<?php echo base_url(); ?>index.php/Exampanel/writinganswerpreview?ex_id=<?php echo $log->ex_id; ?>">Preview</a>
  ...
  <?php 
		...
		{
		 echo "<a class='btn btn-danger' href='".base_url()."index.php/Exampanel/writingmodule?ex_id=".$log->ex_id."'>Retake this Module</a>";
		}
	?>  
