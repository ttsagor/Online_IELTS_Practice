...
<div class="ui-layout-south">
	...
	<button class='btn btn-primary' onclick='setsection("3")'>Section 3</button> <br/> <p>&nbsp;</p>
...
<div class="ui-layout-east" id='answer_panel'>
	<div id='answer_1'>
		<?php 
			$answer = str_replace('<i class="sjl_fa fa-pencil" style="cursor: pointer;"></i>'," ",html_entity_decode($data->sec_one_answer_paper));
			echo $answer; 
		?>
	</div>
	<div id='answer_2' style='display:none;'>
		<?php 
			$answer = str_replace('<i class="sjl_fa fa-pencil" style="cursor: pointer;"></i>'," ",html_entity_decode($data->sec_two_answer_paper));
			echo $answer; 
		?>
	</div>
	<div id='answer_3' style='display:none;'>
		<?php 
			$answer = str_replace('<i class="sjl_fa fa-pencil" style="cursor: pointer;"></i>'," ",html_entity_decode($data->sec_three_answer_paper));
			echo $answer; 
		?>
	</div>
</div>
...
<form method='post' action='<?php echo base_url(); ?>index.php/Exampanel/submitreading' id='main_form'>
...
<script>
	...
	function setsection(sec)
	{
		...
		document.getElementById('answer_'+sec).style.display='block';
	}
    function createNumSl(){
       $("#sl_holder" ).html("");  
      var data = document.getElementById('answer_panel').querySelectorAll('input,select');
      
      var answer_1 = document.getElementById('answer_1').querySelectorAll('input,select');
      var answer_2 = document.getElementById('answer_2').querySelectorAll('input,select');
      var answer_3 = document.getElementById('answer_3').querySelectorAll('input,select');
