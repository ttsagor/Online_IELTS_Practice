	...
	<form method='post' action='<?php echo base_url(); ?>index.php/AdminPanel/listeningquestionaddpassageformsubmit' id='form'>
  ...
  <div class=''  style="background:rgba(0, 0, 0, 0) url('image/16.jpg') no-repeat fixed 0 0 / 100% auto">
				...
				<div class="sjl_sidebar-nav">
					<div id='sourena' class='sjl_panel sjl_panel-default' style="border:4px inset lightgray;padding-left:0;padding-right:0;margin-top:18px;">
						<div class="sjl_panel-heading" style="border-bottom: 1px solid gray;">
							<h3 class="sjl_panel-title"><span style='cursor:pointer' onclick="attrib.get_author_detail();">Design Tool</h3>
						</div>
	...
	<script>
        ...
        */
        ...
        <img class="sjl_shake" src="<?php echo base_url(); ?>assets/form-builder/image/help_icon.png" alt="help me" style='cursor:pointer;position:absolute;right:10px;top:10px;' onclick="on_help_icon_clicked();">
        <script>    
            function on_help_icon_clicked(a){
                SJL.dom("img.sjl_shake").remove_css_class('sjl_shake');
                window.open("bside_doc/index.html");
            }
